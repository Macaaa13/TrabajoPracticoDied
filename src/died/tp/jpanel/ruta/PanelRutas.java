...
public class PanelRutas extends JPanel {
	...
	public void setComboBoxOrigen(JComboBox<String> comboBoxOrigen) {
		this.comboBoxOrigen = comboBoxOrigen;
	}

	public JComboBox<String> getComboBoxDestino() {
		return comboBoxDestino;
	}

	public void setComboBoxDestino(JComboBox<String> comboBoxDestino) {
